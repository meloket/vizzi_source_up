        ...
        <b-card v-if="!addNew">
            ...
            <div class="table-responsive">
                ...
                >
                    ...
                    <template v-slot:cell(session)="data">
                        <div class="mt-2">{{data.item.session.title}}</div>
                    </template>
                    ...
                    <template v-slot:cell(status)="data">
                        <div class="mt-2">{{getStatus(data.item.session.event)}}</div>
                    </template>
            ...
            <div class="container mb-2 mx-auto">
                ...
                <b-row>
                    <b-colxx md="6" sm="12">
                        ...
                        <b-form-group label="Linked Session*" class="my-2">
                            <b-form-select v-model="item.session_id">
                                <option :value="data.id" v-for="data in sessionData" :key="data.id">
                                    {{data.title}}
                                </option>
                            </b-form-select>
                        </b-form-group>
    ...
    methods: {
        ...
        edit(editItem) {
            ...
            this.item = {
                ...
                session_id: editItem.session_id,
